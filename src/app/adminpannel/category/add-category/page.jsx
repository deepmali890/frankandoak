...
function page() {
  return (
    ...
    <h4 className="bg-[#F8F8F9]  py-3  text-[25px] rounded-t-lg px-4">Add Category</h4>
    <div className="px-4  bg-white pt-9 pb-6 rounded-b-lg  ">
        ...
        <textarea type="text" className=" w-full border-[1px] py-[6px] rounded-lg outline-none my-3 ps-2" />
        </div>
