...
function page() {
  return (
    ...
    <h4 className="bg-[#F8F8F9]  py-3 text-[25px] rounded-t-lg px-4">View Category</h4>
        ...
        <tr className=" border-b-[1px]">
          ...
          <td class="px-5    bg-white text-md ">
            <span
              ...
              <span>
              <img src="https://admin-panel-self-sigma.vercel.app/CollarPocketsT-shirt1.webp" alt="product men's t-shirt" width="80" height="80"/>
              </span>
            </span>
          </td>
