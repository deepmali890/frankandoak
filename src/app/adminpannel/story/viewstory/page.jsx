    ...
    <table class="min-w-full leading-normal">
      <thead>
        <tr className="border-b-[1px]">
          ...
          >
         <span className=" py-3   rounded-lg text-center">Delete</span>
...
Description
      ...
      <tbody>
        ...
        <tr className=" border-b-[1px]">
          ...
          <td class="px-5    bg-white text-md ">
          <img src="https://admin-panel-self-sigma.vercel.app/Story_Img.avif" alt="story img" width="80" height="80" class="rounded-[5px]"/>
          </td>
          
          <td class="px-5    bg-white text-md ">
          <img src="https://admin-panel-self-sigma.vercel.app/Story_Banner.webp" alt="story img" width="150" height="150" class="rounded-[5px]"/>
          </td>
